...
<TABLE width="100%" height="40" cellpadding="0" border="0">
<tr>
...
<td  bgcolor="#999999" align="middle"><font  face="<?php echo "".$police."";?>" size="<?php echo"".$taille."";?>" color="<?php echo"".$color2."";?>">Pékin </td>
